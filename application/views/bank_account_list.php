...
<title>Daftar Rekening Pembeli</title>
...
<style>
    ...
    .badge-user { background-color: #20c997; font-weight: 600; }
...
<div class="container-fluid px-4 pb-5">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h5 class="mb-1"><i class="bi bi-credit-card me-2"></i>Daftar Rekening Pembeli</h5>
            <p class="text-muted small">Keterangan: rekening bank konsumen digunakan untuk verifikasi pembayaran dan proses refund. Klik ikon mata untuk melihat detail rekening milik konsumen tersebut.</p>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>Konsumen</th>
                            <th class="text-end">Jumlah Rekening</th>
...
$(function () {
    ...
    function render(rows) {
        ...
        $body.empty();
        if (rows.length === 0) {
            $body.append('<tr><td colspan="4" class="text-center text-muted py-4">Belum ada rekening konsumen tersimpan.</td></tr>');
            return;
        }
        rows.forEach(function (row, idx) {
            ...
            tr.append('<td class="text-end">' + row.n_account + '</td>');
            var actionTd = $('<td class="text-center">');
            var viewBtn = $('<a class="btn btn-sm btn-outline-primary btn-icon" title="Lihat detail rekening"><i class="bi bi-eye"></i></a>');
